...
/* 
TO DO:
- add logo in email template
- fix missing email parameters
*/
...
exports.sendMail = functions.https.onRequest((request, response) => {
  cors(request, response, () => {
    ...
    // Conditional for sending Estimate
    if (total) {

      //For Website Estimate
      if (category) {
        mailOptions = {
          ...mailOptions,
          to: "das.software.dev@gmail.com",
        ...
        //For Custom Software or iOS/Android
      } else {
        mailOptions = {
          ...mailOptions,
          to: "das.software.dev@gmail.com",
                            ...
                            <td align="center">
                              ...
                              >
                                <tr>
                                  <td align="center">
                                    <a
                                      href="http://www.dasdevelopment.com/"
                                      target="_blank"
                                    >
                                    // Place logo here
                                      <img
